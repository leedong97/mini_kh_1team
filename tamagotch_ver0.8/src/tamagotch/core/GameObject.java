...
public abstract class GameObject {
    ...
    public  String objCase = "normal"; //move, normal //작업편의를 위해 public으로 두었습니다.
    ...
    */
    ...
    public void updateAnim(){
        ...
        //     body.getParent().repaint(body.getX(), body.getY(), body.getWidth(), body.getHeight());
        // }
    }
