...
public class Pet extends GameObject{
    ...
    public Pet(PetClone petClone) {
        this.name = petClone.getName();
        this.hunger = petClone.getHunger();
        this.hygiene = petClone.getHygiene();
        this.fun = petClone.getFun();
        this.restroom = petClone.getRestroom();
        // 생성자
        petAlgo = new ArrayList<PetAlgo>();
