    ...
    // Frame 설정
        ...
        startBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String grahp = "|";
                grahps = grahp.repeat(gauge);
                
                Label gaugeLabel2 = new Label (gauge + "%",Label.CENTER);
                gaugeLabel2.setBounds(
                    f.getSize().width/2 - 150
                    ,60,300,30);
                f.add(gaugeLabel2);
                //게이지label
                Label gaugeLabel = new Label (grahps);
                    ...
                    public void run() {
                        while(tb){
                            try {
                                ...
                                gauge --;
                                grahps = grahp.repeat(gauge);
                                gaugeLabel.setText(grahps);

                                gaugeLabel2.setText(gauge + "%");

                                if(gauge < 0){
                                    gaugeLabel2.setText("패배하였습니다");
                                    f.remove(btn);
                                    f.remove(btn2);
                                    gauge = 50;
                                    f.add(startBtn);
